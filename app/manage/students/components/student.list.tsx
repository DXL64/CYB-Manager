...
export default function StudentList({ students, searchTerm, setSearchTerm }: StudentListProps) {
    ...
    <>
      <div className="flex justify-between items-center mb-6">
        ...
        <Dialog open={isNewModalOpen} onOpenChange={setIsNewModalOpen}>
          <StudentForm student={editingModel} onClose={() => setIsNewModalOpen(false)} />
        </Dialog>
