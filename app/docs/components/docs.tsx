      ...
      >
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                1. Nhấn vào nút{" "}
                <Button size="sm">
                  <PlusCircle className="mr-2 h-4 w-4" /> Thêm thông tin
                </Button>{" "}
              ...
              <ul className="list-disc list-inside pl-4 space-y-2">
                <li>
                  Tải lên <strong>ảnh đại diện</strong>
                </li>
                <li>
                  Nhập <strong>họ và tên</strong>
                </li>
                <li>
                  Chọn <strong>giới tính</strong>
                </li>
                <li>
                  Nhập <strong>địa chỉ email</strong>
                </li>
                <li>
                  Nhập <strong>số điện thoại</strong>
                </li>
                <li>
                  Chọn <strong>môn chuyên</strong>
                </li>
                <li>
                  Chọn <strong>ngày sinh</strong>
                </li>
                <li>
                  Nhập <strong>niên khóa</strong>
                </li>
              </ul>
              ...
              <p style={{ border: "1px solid black", padding: "15px", backgroundColor: "rgba(128, 128, 128, 0.5)", borderRadius: "8px" }}>
                <strong>Lưu ý:</strong> Giáo viện hiện nay vẫn còn tiếp tục làm việc để trống trường &quot;Kết thúc làm việc&ldquo;.
              </p>
              <p>
                3. Sau khi điền đầy đủ thông tin, nhấn nút <strong>Lưu</strong> để thêm mới vào hệ thống.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="search">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                1. Tại đầu trang, bạn sẽ thấy một ô tìm kiếm{" "}
                <span className="inline-flex items-center border rounded px-2 py-1">
                  <Search className="h-4 w-4 mr-2" /> Tìm kiếm theo tên
                </span>
                .
              </p>
